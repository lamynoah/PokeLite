...
public partial class ExerciceMonsterContext : DbContext
{
    ...
    public static string NomServ { get; set; } = "PC-NOAH\\SQLEXPRESS";

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer($"Server={NomServ};Database=ExerciceMonster;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Login>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Login__3214EC27C995F9D9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Monster__3214EC271EA71617");
            ...
            entity.HasMany(d => d.Spells).WithMany(p => p.Monsters)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MonsterId", "SpellId").HasName("PK__MonsterS__293EA4DFDE703B43");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Player__3214EC272CA902F3");
            ...
            entity.HasMany(d => d.Monsters).WithMany(p => p.Players)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("PlayerId", "MonsterId").HasName("PK__PlayerMo__378F20A4AF1A91E3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Spell__3214EC27DFF2FBE7");
